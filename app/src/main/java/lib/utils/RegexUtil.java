...
public final class RegexUtil {
	 ...
	 * @param idCard
	 * 				一代身份证号码15位
	 *            二代居民身份证号码18位，最后一位可能是数字或字母
	 * @return 验证成功返回true，验证失败返回false
	 */
	public static boolean checkIdCard(String idCard) {
//		String regex = "[1-9]\\d{13,16}[a-zA-Z0-9]{1}";
		String re = "^[1-9]\\d{7}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}$";
		String regex = "^[1-9]\\d{5}[1-9]\\d{3}((0\\d)|(1[0-2]))(([0|1|2]\\d)|3[0-1])\\d{3}([0-9]|X)$";
		return Pattern.matches(re, idCard) || Pattern.matches(regex, idCard);
	}

//	/**
//	 * 验证护照
//	 * 规则：暂时先定义为首字母为英文，后为数字（至少7位数）
//	 * @param passport
//	 * @return
//	 */
//	public static boolean checkPassport(String passport) {
//		String regex = "[a-zA-Z]{1}[1-9]\\d{,}";
